...
const ActivityHistoryCard: React.FC<ActivityHistoryProps> = ({ title, activities }) => {
  ...
  return (
    <div className="w-full h-full bg-[#2E2E2E] lg:col-span-2 p-6 mr-20 my-4 rounded-lg text-[#D3D3D3] flex flex-col">
      ...
      <div className="relative w-full flex-1 min-h-0">
        ...
        {/* 
          Make the list scrollable and fill available space.
          flex-1 and min-h-0 on parent ensure proper stretching in a flex column.
        */}
        <ul className="space-y-4 pl-6 overflow-y-auto h-full">
